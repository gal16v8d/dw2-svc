...
class AttackTargetTypeServiceIT {
	...
	@Test
	void saveTest() {
		AttackTargetTypeModel result = service.save(AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build());
		Assertions.assertNotNull(result);
	...
	@Test
	void updateTest() {
		AttackTargetTypeModel result = service.update(SELF_ID,
				AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build());
		Assertions.assertNotNull(result);
		Assertions.assertEquals(RANDOM_ALLIES, result.getName());
	}
	...
	void updateNoMatchTest() {
		Assertions
				.assertNull(service.update(ID_NOT_FOUND, AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build()));
	}

	@Test
	void patchTest() {
		AttackTargetTypeModel result = service.patch(SELF_ID,
				AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build());
		Assertions.assertNotNull(result);
		Assertions.assertEquals(RANDOM_ALLIES, result.getName());
	}
	...
	void patchNoMatchTest() {
		Assertions.assertNull(service.patch(ID_NOT_FOUND, AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build()));
	}
