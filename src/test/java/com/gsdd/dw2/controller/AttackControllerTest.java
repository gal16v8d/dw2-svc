...
class AttackControllerTest {
  ...
  void getAllTest() throws Exception {
    willReturn(Arrays.asList(AttackModel.builder().attackTypeId(1L).attackTargetTypeId(1L)
        .attackId(1L).mp(0).name(NECRO_MAGIC).build())).given(attackService).getAll();
  ...
  void getByIdTest() throws Exception {
    willReturn(AttackModel.builder().attackTypeId(1L).attackTargetTypeId(1L).attackId(1L).mp(0)
        .name(NECRO_MAGIC).build()).given(attackService).getById(anyLong());
    mvc.perform(
  ...
  void saveTest() throws Exception {
    AttackModel model = AttackModel.builder().attackTypeId(1L).attackTargetTypeId(1L).attackId(1L)
        .mp(16).name(SMILEY_BOMB).build();
