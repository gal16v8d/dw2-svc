...
class AttackTargetTypeServiceIT {
  ...
  void updateTest() {
    AttackTargetTypeModel result =
        service.update(SELF_ID, AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build());
    Assertions.assertNotNull(result);
    Assertions.assertEquals(RANDOM_ALLIES, result.getName());
  }
  ...
  void updateNoMatchTest() {
    Assertions.assertNull(
        service.update(ID_NOT_FOUND, AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build()));
  }
  ...
  void patchNoMatchTest() {
    Assertions.assertNull(
        service.patch(ID_NOT_FOUND, AttackTargetTypeModel.builder().name(RANDOM_ALLIES).build()));
  }
